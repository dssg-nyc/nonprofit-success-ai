...
Portable design spec. Drop into another React or React Native (TypeScript) app to reproduce visual language. Source of truth: [src/app/index.css](../../src/app/index.css).
